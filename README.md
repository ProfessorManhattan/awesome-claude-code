...
- [Claude Skills](https://github.com/megabytespace/claude-skills) by [Brian Zalewski](https://github.com/ProfessorManhattan) - A 14-category autonomous product-building OS with 57 skills and 18 specialized agents. Turns one-line prompts into deployed products on Cloudflare Workers. Covers the full lifecycle from architecture through deploy verification, with TDD enforcement, AI visual QA, parallel agent orchestration, and auto-learning from every prompt. Stack: CF Workers+Hono, Angular+Ionic+PrimeNG, D1/Neon, Drizzle, Clerk, Stripe, Inngest, Resend, Bun, Playwright.
